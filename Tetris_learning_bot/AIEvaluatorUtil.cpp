...
//}
//
//DesiredMoveSet AIEvaluatorUtil::__FindBestMove(Stack* tetrisBoard, AIEvaluatorComponent * ownerComp, int numLookaheads, bool holdPiece)
//{
//	DesiredMoveSet result;
//
//	numLookaheads--;
//
//	if (!tetrisBoard->curpieceg)
//	{
//		return result;
//	}
//
